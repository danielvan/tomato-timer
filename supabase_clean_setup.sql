...
-- This creates all the tables and policies for Optimitimer (handles existing objects)
...
DROP TABLE IF EXISTS public.dividers CASCADE;
...
DROP TRIGGER IF EXISTS handle_updated_at_task_groups ON public.task_groups CASCADE;
DROP TRIGGER IF EXISTS handle_updated_at_tasks ON public.tasks CASCADE;
